...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://poj2i0ajm6.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.folderItemPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['item', 'folder', 'Content-Type', 'x-amz-meta-customLabels', 'Content-Disposition'], ['body']);
        ...
        var folderItemPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'x-amz-meta-customLabels', 'Content-Disposition']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
